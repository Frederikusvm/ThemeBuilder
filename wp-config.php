...
define( 'DB_NAME', 'standaard123' ); 

/** Database username */
define( 'DB_USER', 'standaard123' ); // in verband met veiligheid heb ik hier in de config niet de echte gegevens gebruikt

/** Database password */
define( 'DB_PASSWORD', 'standaard123' );
